...
import com.shop.nucknuckshop.user.config.MockMvcRestDocumentationConfig;
...
import static com.shop.nucknuckshop.user.config.ClearFieldDescriptor.*;
...
class UserSignControllerTest {
    ...
    @Test
    @DisplayName("회원가입 실패 - 유효성 검증 실패 1. 비밀번호에 특수문자 없음")
    @SneakyThrows
    @WithMockUser
